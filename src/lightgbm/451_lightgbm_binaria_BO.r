...
PARAM$hyperparametertuning$xval_folds <- 8
...
hs <- makeParamSet(
  ...
  makeNumericParam("feature_fraction", lower = 0.001, upper = 1.0),
  makeIntegerParam("min_data_in_leaf", lower = 1L, upper = 50000L),
  makeIntegerParam("num_leaves", lower = 30L, upper = 1000),
  makeIntegerParam("envios", lower = 3000, upper = 18000),
  makeNumericParam("min_gain_to_split", lower = 0.00, upper = 10),
  makeNumericParam("lambda_l1", lower = 0.01, upper = 1000),
  makeNumericParam("lambda_l2", lower = 0.01, upper = 1000)
)

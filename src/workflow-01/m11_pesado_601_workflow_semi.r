...
FEintra_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/workflow-01/m01_pesado_531_FE_intrames.r"
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train <- c(201901, 201902, 201903, 201904,
     201905, 201906, 201907, 201908, 201909, 201910, 201911, 
     201912,202001, 202002, 202003, 202101, 
     202102, 202103, 202104, 202105, 202106, 202107)


  param_local$train$training <- c(201901, 201902, 201903, 201904,
     201905, 201906, 201907, 201908, 201909, 201910, 201911, 
     201912,202001, 202002, 202003, 202101, 
...
HT_tuning_base <- function( pinputexps, bypass=FALSE)
{
  ...
  param_local$lgb_param <- list(
    ...
    lambda_l1 = c( 0.0, 1000.0 ), # lambda_l1 >= 0.0
    ...
    is_unbalance = FALSE, #
    scale_pos_weight = c( 460, 480 ), # scale_pos_weight > 0.0
    ...
    extra_trees = FALSE,
    # Parte variable
    learning_rate = c( 0.09, 0.13 ),
    feature_fraction = c( 0.3, 0.5 ),
    num_leaves = c( 90L,  150L,  "integer" ),
    min_data_in_leaf = c( 6000L, 9500L, "integer" )
  )
...
wf_semillerio9 <- function( pnombrewf )
{
  ...
  CN_canaritos_asesinos_base(ratio=0.95, desvio=-1.0)
